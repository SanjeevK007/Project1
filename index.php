			...
			<header id="header" class="hoc clear">
				...
				<nav id="mainav" class="fl_right"> 
					<ul class="clear">
						...
						<li><a href="YoutubeVideos.php">Save Videos</a></li>
				...
				<form action="#">
					<select>
						...
						<option value="YoutubeVideos.php">Save Videos</option>
				...
				<div class="content"> 
					<div id="gallery">
							...
							<?php	
								...
								$db = new DbConnect();
								$conn = $db->connect();
								$stmt = $conn->prepare("SELECT * FROM videos order by id desc LIMIT 10 ");
								$stmt->execute();
